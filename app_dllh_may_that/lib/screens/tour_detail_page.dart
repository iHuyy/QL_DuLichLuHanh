    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Hình ảnh (Tour image can be data URL, base64 or remote URL)
            ClipRRect(
            ...
            Center(
              child: ElevatedButton(
                onPressed: () async { // Thêm async để chờ kết quả từ BookingPage
                  ...
                  // Nếu BookingPage trả về kết quả thành công, pop lại và gửi tín hiệu refresh (true)
