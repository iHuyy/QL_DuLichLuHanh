...
if (!$user_conn) {
    ...
    // --- XỬ LÝ CÁC MÃ LỖI ORACLE ---
    if (stripos($msg, 'ORA-28000') !== false) {
        $responseMsg = "Tài khoản đã bị khóa (Quá số lần đăng nhập).";
    } elseif (stripos($msg, 'ORA-28001') !== false) {
        // [MỚI] Phát hiện mật khẩu hết hạn -> Trả về signal yêu cầu đổi pass
        echo json_encode([
            "success" => false,
